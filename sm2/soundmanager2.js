...
// The baseMimeTypes and netStreamMimeTypes regular expressions have been slightly modified to fix a bug.
...
function SoundManager(smURL, smID) {
  ...
  this.netStreamMimeTypes = /^\s*audio\/(?:x-)?(?:mp(?:eg|3)|mp4a-latm|aac|speex)\s*(?:$|;)/i; // mp3, mp4, aac etc.
